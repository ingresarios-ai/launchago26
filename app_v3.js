...
const activitiesData = {
  ...
  6: {
    ...
    render: () => `
      ...
      <a href="https://chat.whatsapp.com/KPo9FxyT1f4I7B0sobLDtG" target="_blank" class="btn-secondary" style="display:block; text-align:center; text-decoration:none; margin-bottom: 16px;">
