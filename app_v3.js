...
const activitiesData = {
  ...
  6: {
    ...
    render: () => `
      ...
      <a href="https://chat.whatsapp.com/BDA8c0TXKOJ6e2pDZzN28W" target="_blank" class="btn-secondary" style="display:block; text-align:center; text-decoration:none; margin-bottom: 16px;">
